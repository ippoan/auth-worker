/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 06e6581af8f4d29a0b45d509cced8689)
// Runtime types generated with workerd@1.20260329.1 2024-12-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LineworksWebhookDO" | "McpSession";
	}
	interface StagingEnv {
		AUTH_CONFIG: KVNamespace;
		MCP_OAUTH_KV: KVNamespace;
		INTERNAL_SHARED_SECRET: SecretsStoreSecret;
		MCP_JWT_SECRET: SecretsStoreSecret;
		ACCESS_OIDC_SIGNING_KEY: SecretsStoreSecret;
		ACCESS_OIDC_CLIENTS: SecretsStoreSecret;
		INTERNAL_SHARED_SECRET_CI_DASHBOARD: SecretsStoreSecret;
		GOOGLE_CLIENT_ID: SecretsStoreSecret;
		GOOGLE_CLIENT_SECRET: SecretsStoreSecret;
		JWT_SECRET: SecretsStoreSecret;
		ALC_STAGING_API_KEY: SecretsStoreSecret;
		ALC_API_PROXY_SA_KEY: SecretsStoreSecret;
		GITHUB_MCP_CLIENT_ID: SecretsStoreSecret;
		GITHUB_MCP_CLIENT_SECRET: SecretsStoreSecret;
		GITHUB_MCP_USER_ALLOWLIST: SecretsStoreSecret;
		GITHUB_WEBHOOK_SECRET: SecretsStoreSecret;
		SSO_ENCRYPTION_KEY: SecretsStoreSecret;
		LINE_LOGIN_CHANNEL_ID: SecretsStoreSecret;
		LINE_LOGIN_CHANNEL_SECRET: SecretsStoreSecret;
		GOOGLE_HEALTH_CLIENT_ID: SecretsStoreSecret;
		GOOGLE_HEALTH_CLIENT_SECRET: SecretsStoreSecret;
		BROWSER: Fetcher;
		AUTH_WORKER_ORIGIN: "https://auth-staging.ippoan.org";
		ACCESS_TEAM_DOMAIN: "mtamaramu.cloudflareaccess.com";
		...
		MCP_RESOURCE_ORIGINS_ALLOWLIST: "https://security-inventory.ippoan.org,https://security-rotate.ippoan.org,https://ref-files.ippoan.org,https://cf-access-mcp.ippoan.org,https://cdp-relay.ippoan.org,https://gmail-mcp.ippoan.org,https://ci-dashboard.ippoan.org,https://kyuyo-mcp.ippoan.org";
		MCP_RESOURCE_GOOGLE_ORIGINS: "https://kyuyo-mcp.ippoan.org";
		HCREADER_WORKER_ORIGIN: "https://hcreader.ippoan.org";
		LINEWORKS_WEBHOOK_DO: DurableObjectNamespace<import("./src/index").LineworksWebhookDO>;
		MCP_SESSION_DO: DurableObjectNamespace<import("./src/index").McpSession>;
		CF_FLICKR_CAM_WORKER: Fetcher /* cf-flickr-cam-worker */;
		ALC_RECORDER: Fetcher /* alc-recorder-staging */;
	}
	interface Env {
		AUTH_CONFIG: KVNamespace;
		MCP_OAUTH_KV: KVNamespace;
		...
		GOOGLE_HEALTH_CLIENT_SECRET?: SecretsStoreSecret;
		BROWSER: Fetcher;
		AUTH_WORKER_ORIGIN: "https://auth-staging.ippoan.org" | "https://auth.ippoan.org";
		ACCESS_TEAM_DOMAIN: "mtamaramu.cloudflareaccess.com";
		ALC_API_ORIGIN: "https://rust-alc-api-staging-566bls5vfq-an.a.run.app" | "https://alc-api.ippoan.org";
		ALC_API_STAGING_ORIGIN: "https://rust-alc-api-staging-566bls5vfq-an.a.run.app";
		WORKER_ENV: "staging" | "prod";
		INTERNAL_AUTH_OIDC: "1";
		DEBUG?: "true";
		EGOV_AUTH_BASE: "https://account2.sbx.e-gov.go.jp/auth";
		EGOV_CLIENT_ID: "K26XGOmbDusxfKsp";
		MCP_JWT_AUDIENCE_ALLOWLIST: "github-mcp-server-rs,ref-files-mcp-server-rs";
		MCP_HEADLESS_GRANT_ENABLED?: "1";
		MCP_RESOURCE_ORIGINS_ALLOWLIST: "https://security-inventory.ippoan.org,https://security-rotate.ippoan.org,https://ref-files.ippoan.org,https://cf-access-mcp.ippoan.org,https://cdp-relay.ippoan.org,https://gmail-mcp.ippoan.org,https://ci-dashboard.ippoan.org,https://kyuyo-mcp.ippoan.org" | "https://security-inventory.ippoan.org,https://security-rotate.ippoan.org,https://ref-files.ippoan.org,https://cf-access-mcp.ippoan.org,https://gmail-mcp.ippoan.org";
		MCP_RESOURCE_GOOGLE_ORIGINS: "https://kyuyo-mcp.ippoan.org" | "";
		HCREADER_WORKER_ORIGIN?: "https://hcreader.ippoan.org";
		LINEWORKS_WEBHOOK_DO: DurableObjectNamespace<import("./src/index").LineworksWebhookDO>;
		MCP_SESSION_DO: DurableObjectNamespace<import("./src/index").McpSession>;
		CF_FLICKR_CAM_WORKER: Fetcher /* cf-flickr-cam-worker */;
		ALC_RECORDER: Fetcher /* alc-recorder-staging */ | Fetcher /* alc-recorder */;
		ICHIBANBOSHI_PROXY_SA_KEY?: SecretsStoreSecret;
		ICHIBANBOSHI_ORIGIN?: "https://rust-ichibanboshi-747065218280.asia-northeast1.run.app";
		ALC_API_PREVIEW_HOST_SUFFIX?: "rust-alc-api-747065218280.asia-northeast1.run.app";
		ALC_PROXY_DEV_WRITE_ALLOWLIST?: "";
	}
}
